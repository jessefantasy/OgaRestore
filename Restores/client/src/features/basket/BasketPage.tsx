...
import { Add, AddBox, Delete, Remove } from "@mui/icons-material";
...
export default function BasketPage() {
    ...
    function  handleAddItem(productId: number, name: string) {
        ...
        .catch(error => console.log(error))
        .then(() => setStatus({loading: false, name: ''}));
    }
        ...
        <Table sx={{ minWidth: 650 }}>
          ...
          <TableBody>
            {basket.items.map(item => (
              ...
              >
                ...
                <TableCell align="center">
                    ...
                    {item.quantity}
                    <LoadingButton loading={status.loading && status.name === 'add' }  onClick={() => handleAddItem(item.productId, 'add' + item.productId)} color="secondary">
                        <Add/>
                    </LoadingButton>
                    </TableCell>
            ...
            <Grid container>
                ...
                <Grid item xs={6}>
                    <BasketSummary/>
                    <Button fullWidth size="large" variant="contained" component={Link} to='/checkout' >Checkout</Button>
                </Grid>
